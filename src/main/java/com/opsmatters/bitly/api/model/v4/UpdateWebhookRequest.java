...
/**
 * Represents a request to update a webhook.
 * 
...
public class UpdateWebhookRequest
{
    ...
    /**
     * Sets the GUID of the webhook.
     * @param guid The GUID of the webhook
     */
    ...
    {
        private UpdateWebhookRequest request = new UpdateWebhookRequest();
